...
public final class Entities {
    ...
    private static final List<EntityType> HOSTILES = Arrays.asList(WITHER_SKELETON, WITHER, SILVERFISH, ENDERMAN,
            ...
            PHANTOM, PILLAGER, RAVAGER, SHULKER, STRAY, VEX, ZOMBIE_VILLAGER, ZOMBIFIED_PIGLIN, ZOGLIN);
    private static final List<EntityType> AGGERABLES = Arrays.asList(POLAR_BEAR, IRON_GOLEM, PIGLIN, WOLF, SNOWMAN, BEE);
